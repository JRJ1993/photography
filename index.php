  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images/architecture4.jpg" alt="Architecture">
        <div class="carousel-caption d-none d-md-block">
          <h5>Architecture</h5>
        </div>
      </div>
      <div class="carousel-item">
        <img src="images/nature4.jpg" alt="Nature">
        <div class="carousel-caption d-none d-md-block">
          <h5>Nature</h5>
        </div>
      </div>
  ...
  <a id="about">
    <section class="my-4">
      ...
      <div class="container-fluid">
        ...
        <p class="text-center">
          <b>I am a passionate photographer interested in working in architecture, nature and travel. I am a full time free lancer with an exerience of 5 years.</b>
        </p>
      </div>
    </section>
  </a>
